...
dados_vendas_limpos |> 
  summarise(numero_representates = n_distinct(representante))
...
# calcula a receita médiua por cidade e produto
dados_vendas_limpos |> 
...
# ordena os dados por receita rm ordem crescente
dados_vendas_limpos |> 
  arrange(receita)

# ordena os dados por receita em ordem deceresente 
dados_vendas_limpos |> 
